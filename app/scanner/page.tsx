...
import { ChevronLeft, ScanLine, Camera, X } from "lucide-react";
...
// Mock barcode database for Indonesia
...
export default function ScannerPage() {
  ...
  const handleScanBarcode = () => {
    // Simulate barcode scan with mock database
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground text-center">
                <p>
                  Barcode scanner menggunakan kamera perangkat. Pastikan pencahayaan cukup.
                </p>
              </div>
            </CardContent>
          </Card>
