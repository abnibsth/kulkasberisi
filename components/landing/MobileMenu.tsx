  ...
  return (
    <div className="md:hidden">
      ...
      <button
        ...
        className="w-9 h-9 rounded-full border border-black/8 bg-white/80 flex items-center justify-center text-[#5a5550] hover:text-[#141210] transition-all duration-200 hover:border-black/15"
      ...
      >
        ...
        <nav className="flex flex-col px-8 pt-8 gap-0">
          {links.map(([h, l], i) => (
            <Link
              ...
              href={h}
              onClick={() => setOpen(false)}
              className="py-5 border-b border-black/06 text-2xl font-semibold tracking-tight text-[#141210] hover:text-[#2d6a4f] transition-colors duration-200"
              style={{
        ...
        >
          <Link
            href="/login"
            onClick={() => setOpen(false)}
            className="w-full h-12 flex items-center justify-center rounded-full border border-black/12 text-[#141210] font-semibold text-sm hover:bg-black/[0.03] transition-colors"
          >
            Masuk
          </Link>
          <Link
